# skill-netlinking
AI-powered Claude Skill for automating backlink analysis and netlinking campaigns.
...
Téléchargez le fichier netlinking-audit.skill depuis la dernière Release.
2. Préparer votre Claude
Sur claude.ai :

Allez dans Settings > Capabilities
Activez Code execution and file creation
Activez Skills

3. Uploader le skill

Allez dans Customize > Skills
Cliquez sur "+" puis "+ Upload skill"
Sélectionnez le fichier netlinking-audit.skill téléchargé
Le skill apparaît dans votre liste — activez-le via le toggle
...
👤 Auteur
Créé par @diego-epic — consultant SEO/GEO freelance.
